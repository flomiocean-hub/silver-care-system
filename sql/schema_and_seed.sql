...
INSERT INTO members (id,name,birthday,gender,mobile,home_phone,address,emergency_contact,member_type,tags,notes,join_date,last_seen,risk_score,status,weight_baseline) VALUES
('SC-001','陳美華','1942-03-15','女','0912-345-678','02-2345-6789','台北市中正區忠孝路1號','陳志明 0912-999-001','出席型',ARRAY['獨居','高風險'],'高血壓病史','2023-01-10','2025-04-18',72,'活躍',53.0),
('SC-002','林德正','1938-07-22','男','0923-456-789','','台北市大安區仁愛路2段5號','林小玲 0923-999-002','出席型',ARRAY[]::TEXT[],'','2023-02-15','2025-05-02',15,'活躍',69.0),
('SC-003','王淑芬','1945-11-08','女','0934-567-890','02-3456-7890','台北市信義區松仁路10號','王大明 0934-999-003','出席型',ARRAY['獨居'],'輕度失智觀察中','2023-03-20','2025-04-30',45,'活躍',55.5),
('SC-004','黃文雄','1940-05-30','男','0945-678-901','','台北市松山區南京東路3段20號','黃美珠 0945-999-004','出席型',ARRAY[]::TEXT[],'','2023-01-25','2025-05-03',20,'活躍',72.5),
('SC-005','張桂英','1947-09-12','女','0956-789-012','02-5678-9012','台北市士林區中正路50號','張小華 0956-999-005','出席型',ARRAY['獨居','高風險','電訪追蹤'],'連續缺席超過14天','2023-04-05','2025-04-10',85,'高風險',48.0),
('SC-006','李榮發','1935-12-03','男','0967-890-123','02-6789-0123','台北市北投區中央北路1段8號','李美玉 0967-999-006','出席型',ARRAY[]::TEXT[],'糖尿病','2022-11-15','2025-05-01',30,'活躍',65.0),
('SC-007','吳秀蘭','1943-06-18','女','0978-901-234','','台北市文山區木柵路2段15號','吳建志 0978-999-007','出席型',ARRAY['獨居','高風險'],'血壓不穩定','2023-05-10','2025-04-25',60,'注意',58.5),
('SC-008','劉進財','1939-02-28','男','0989-012-345','','台北市內湖區成功路4段30號','劉淑華 0989-999-008','出席型',ARRAY[]::TEXT[],'','2022-12-01','2025-05-02',10,'活躍',71.0),
('SC-009','許阿珠','1950-04-20','女','0911-111-222','02-1111-2222','台北市萬華區西園路1段60號','許建國 0911-999-009','探訪型',ARRAY['探訪','獨居'],'行動不便，需定期外訪','2024-01-05','2025-04-01',55,'注意',50.0)
